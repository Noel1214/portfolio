...
const CertificateCard: React.FC<CertificateCardProps> = (props) => {
  return (
    <div className="py-7 px-4 bg-gray-900 sm:bg-neutral-900 w-[20rem] sm:w-[24rem] flex justify-center rounded-2xl hover:scale-105 transition-all duration-300 ease-in-out overflow-hidden">
